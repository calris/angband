...
#define BG_BLACK	0	/* The set number for the black-background */
#define BG_SAME		1	/* The set number for the same-background */
#define BG_DARK		2	/* The set number for the dark-background */
...
struct color_type {
	...
	byte color_translate[MAX_ATTR];	/* Idx for in-game translations */
};

extern byte angband_color_table[MAX_COLORS][4];

extern struct color_type color_table[MAX_COLORS];
